...
public class WebDriverWaits {
    ...
    public static void waitUntilElementIsClickable(WebElement element) {
        WebDriverWait wait = new WebDriverWait(WebDriverFactory.getDriver(), 20); // Adjust the timeout as necessary
    ...
    public static void waitUntilPageIsReady() {
        WebDriverWait wait = new WebDriverWait(WebDriverFactory.getDriver(), 20);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("your-correct-css-selector-here"))); // Change to a valid selector
    }
